...
function setup() {
 ...
 sunSprite.visible=false;
  ...
  seedSprite=createSprite(600,600,20,20);
  ...
  can1Sprite=createSprite(720,500,20,20);
  can1Sprite.addImage("can",can1);
  can1Sprite.scale=0.2;
  can1Sprite.visible=false;

  
  bubbleSprite=createSprite(1000,300,20,20);
    ...
    if(gameState==="play") {
      ...
      canSprite.visible=false;
       ...
       if (mousePressedOver(bubbleSprite)) {
        ...
        var co=createSprite(1000,300,20,20);
        co.addImage("bubble",bubble);
        co.scale=random(0.01,0.1);
        co.velocityX=-1;
        co.velocityY=0.5;
